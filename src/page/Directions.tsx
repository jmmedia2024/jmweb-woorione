    ...
    <div style={{ fontSize: `${16 * fontRatio}px` }} className="space-y-10 animate-fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
        ...
        <div className="lg:col-span-7 space-y-4">
          <div className={`relative aspect-[16/10] sm:aspect-[16/11] rounded-[1.5rem] overflow-hidden border flex flex-col justify-between p-6 ${
            highContrast 
              ? "bg-black border-yellow-400 text-yellow-300" 
              : "bg-radial-[at_50%_0%] from-blue-50/20 to-white/80 border-zinc-200/60 shadow-lg shadow-zinc-200/50"
          }`}>
            ...
            <div className="z-10 flex items-center justify-between">
              <span className="text-xxs font-bold text-zinc-800 bg-white/90 backdrop-blur-xs px-2.5 py-1 rounded-md border shadow-xs">
                📌 GPS 정밀 위치 검증
              </span>
            ...
            <div className="z-10 flex flex-col items-center justify-center space-y-2">
              ...
              <div className="bg-white/95 border border-zinc-200/60/90 p-3 rounded-2xl shadow-xl text-center backdrop-blur-xs max-w-xs">
                <h4 className="text-xs font-bold text-zinc-900 leading-tight">비영리민간단체 우리원 쉼터</h4>
                <p className="text-[10px] text-zinc-500 font-semibold mt-0.5 leading-snug">
                  충남 아산시 아산로 105, 2층
                </p>
              </div>
            </div>
            ...
            <div className="z-10 flex items-center justify-between">
              <div className="flex items-center gap-1.5 text-xxs bg-slate-900/90 text-white rounded-lg px-3 py-1.5 font-bold shadow-lg shadow-zinc-200/50">
          ...
          <div className={`p-4 rounded-2xl border flex flex-col sm:flex-row items-center justify-between gap-4 ${
            highContrast ? "bg-black border-yellow-400" : "bg-slate-50 border-zinc-200/60"
          }`}>
            <div className="flex items-start gap-2 text-left">
              <Compass className="w-4 h-4 text-zinc-800 mt-0.5 shrink-0" />
            ...
            <button
              id="copy-address-btn"
              onClick={handleCopy}
              className={`flex items-center justify-center gap-1.5 text-xs font-bold px-4 py-2.5 rounded-xl transition-all active:scale-95 cursor-pointer whitespace-nowrap shadow-lg shadow-zinc-200/50 hover:shadow-md ${
                copied 
                  ? "bg-emerald-600 text-white"
                  : highContrast 
                    ? "bg-yellow-300 text-black border-2 border-yellow-300 hover:bg-yellow-400" 
                    : "bg-white text-zinc-800 hover:bg-slate-100 border border-slate-150/80"
              }`}
            >
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className={`p-6 rounded-[1.5rem] border space-y-6 ${
            highContrast ? "bg-black border-yellow-400 text-yellow-300" : "bg-white border-zinc-200/60 shadow-xs"
          }`}>
            ...
            <div className="flex gap-4 text-left">
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-sm text-zinc-800">지하철 / 전철 이용 시</h4>
                <p className="text-xs text-zinc-500 font-semibold leading-relaxed">
                  <span className="text-zinc-800 font-bold">수도권 전철 1호선 온양온천역</span> 하차 후, <br />
                  <span className="font-bold text-slate-700">2번 출구</span>방향으로 나와 아산시청 삼거리 방향으로 <span className="font-bold text-slate-700">도보 8분</span> 거리.
                </p>
              </div>
            </div>
            ...
            {/* Bus instructions */}
            <div className="flex gap-4 text-left">
              <div className="w-10 h-10 rounded-xl bg-zinc-100 border border-blue-100 flex items-center justify-center shrink-0">
                <Bus className="w-5 h-5 text-zinc-800" />
              </div>
              <div className="space-y-1">
                <h4 className="font-bold text-sm text-zinc-800">지선 / 간선 버스 이용 시</h4>
                <p className="text-xs text-zinc-500 font-semibold leading-relaxed">
                  <span className="text-indigo-600 font-bold">아산 시청 정문 정류장</span> 앞 하차 하신 후, <br />
            ...
            <div className="flex gap-4 text-left">
              ...
              <div className="space-y-1">
                <h4 className="font-bold text-sm text-zinc-800">승용차 자가운전 및 주차</h4>
                <p className="text-xs text-zinc-500 font-semibold leading-relaxed">
                  네비게이션 '우리원 통일마중쉼터' 또는 '아산시 아산로 105' 검색. 건물 후면에 입주 단체 공용 <span className="text-emerald-600 font-bold">무료 전용 주차장</span> 완비되어 상시 주차 가능합니다.
                </p>
              </div>
            </div>
          ...
          {/* Quick Contact Desk */}
          <div className={`p-6 rounded-[1.5rem] border text-left space-y-4 ${
            highContrast ? "bg-black border-yellow-400 text-yellow-300" : "bg-radial-[at_50%_0%] from-blue-50/10 to-indigo-50/10 border-zinc-200/60"
          }`}>
            <h3 className="font-bold text-sm text-slate-850 tracking-wide flex items-center gap-1.5">
            ...
            <div className="space-y-2.5 text-xs text-slate-600 font-semibold leading-relaxed">
              <p className="flex items-center gap-2">
                ...
                <span className="font-bold text-zinc-800">041-544-2020</span>
              </p>
              <p className="flex items-center gap-2">
                <span className="w-16 text-slate-400">위기 긴급전화</span>
                <span className="font-bold text-zinc-800 text-rose-600 font-mono">010-8330-8041</span>
              </p>
              <p className="flex items-center gap-2">
                <span className="w-16 text-slate-400">운영 영업시간</span>
                <span className="text-zinc-800">평일 오전 09:00 - 오후 18:00 (토/일요일 쉼터 자원봉사 개별 상설개방)</span>
              </p>
            </div>
          </div>
        </div>
