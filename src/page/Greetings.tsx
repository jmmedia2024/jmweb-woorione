      ...
      <div className={`p-8 md:p-12 rounded-[1.5rem] border transition-all ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 md:gap-12 items-start">
          ...
          <div className="lg:col-span-4 flex flex-col items-center text-center space-y-5">
            <div className="w-52 h-52 rounded-2xl bg-slate-50 overflow-hidden border border-zinc-200/80 shadow relative group">
              <img 
              ...
              />
              <div className="absolute inset-x-0 bottom-0 bg-blue-900/80 text-white text-xs py-2 font-bold tracking-wider">
                생명 정착 코칭 전문 지도관
              </div>
            </div>
            <div>
              <h3 className="text-lg font-bold text-zinc-900">{LEADERSHIP_MESSAGE.representative}</h3>
            ...
            <div className={`w-full p-5 rounded-2xl border text-left text-xs space-y-3 ${
              highContrast 
                ...
                : "bg-radial-[at_50%_0%] from-slate-50 to-white border-zinc-200/60"
            }`}>
              <p className="font-bold text-zinc-800 flex items-center gap-1.5">
                <UserCheck className="w-4 h-4 text-zinc-800" />
                <span className="font-bold text-sm">채신아 대표 약력</span>
              </p>
          ...
          <div className="lg:col-span-8 space-y-6">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold tracking-widest text-zinc-800 uppercase bg-zinc-100 px-3 py-1 rounded-md">
                GREETING MESSAGE
              </span>
            </div>
            ...
            {/* Official Signature */}
            <div className="pt-8 border-t border-zinc-200/60 flex flex-col items-end text-right space-y-1">
              ...
              <p className="text-zinc-900 font-bold text-lg">
                비영리민간단체 우리원 대표 <span className="font-bold text-lg text-zinc-800 ml-1.5">채 신 아</span> <span className="text-slate-400 text-xs">(직인생략)</span>
              </p>
            </div>
          </div>
