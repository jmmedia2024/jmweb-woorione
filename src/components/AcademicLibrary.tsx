  ...
  return (
    <div className="space-y-12 animate-fade-in text-slate-800" style={{ fontSize: `${16 * fontRatio}px` }}>
      ...
      <div className="border-b border-slate-100 pb-5 max-w-2xl">
        <span className="text-xs font-black uppercase text-blue-600 tracking-wider">Research & Papers Archive</span>
        <h1 className="text-3xl font-black text-slate-900 mt-1">평화통일 전문 학술자료실</h1>
      ...
      <section className="grid grid-cols-1 md:grid-cols-12 gap-4 bg-slate-50 p-4 rounded-2xl border border-slate-200">
        ...
        <div className="md:col-span-7 relative">
          ...
          <input
            ...
            className="w-full pl-11 pr-4 py-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-600 bg-white text-base"
          />
        </div>
        ...
        <div className="md:col-span-5 flex gap-2">
          <select
            ...
            className="w-full p-3 border border-slate-200 rounded-xl focus:ring-2 focus:ring-blue-600 bg-white text-sm font-bold text-slate-700"
          >
              ...
              >
                <div className="flex items-start justify-between gap-4">
                  <div className="space-y-1">
                    <span className="text-[10px] bg-slate-900 text-slate-200 px-2 py-0.5 rounded font-black font-mono">
                      {doc.category}
                    </span>
                    <h3 className="text-lg font-black text-slate-900 leading-tight hover:text-blue-600 transition-colors">
                      {doc.title}
                    </h3>
          ...
          {selectedDoc ? (
            <div className={`p-6 md:p-8 rounded-3xl border space-y-6 ${
              ...
              <div className="flex items-center justify-between border-b border-dashed border-slate-200 pb-4">
                <span className="text-xs bg-blue-100 text-blue-900 px-2.5 py-1 rounded font-black font-mono">
                  READER MODE ACTIVE
                </span>
              ...
              <div className="space-y-2">
                <h4 className="text-xs font-black uppercase text-slate-400 tracking-wider">논문 핵심 요약 요약 (Abstract)</h4>
              ...
              <div className="space-y-3 bg-slate-50 p-4 rounded-xl border border-slate-100">
                <h4 className="text-xs font-black uppercase text-slate-500 tracking-wider">연구 핵심 쟁점 (Key Points)</h4>
              ...
              <div className="pt-2">
                {downloadingId === selectedDoc.id ? (
                  <div className="w-full bg-slate-100 rounded-xl h-12 overflow-hidden border border-slate-200 relative flex items-center justify-center">
                    <div 
                      className="absolute left-0 top-0 bottom-0 bg-blue-600 transition-all text-white font-extrabold flex items-center justify-end pr-2.5" 
                      style={{ width: `${downloadProgress}%` }}
                    ></div>
                    <span className="relative z-10 text-xs font-black text-slate-900 mix-blend-difference">
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-slate-900 border border-slate-800 text-white font-black text-sm rounded-xl hover:bg-slate-800 transition-all flex items-center justify-center gap-1.5 shadow focus:outline-none cursor-pointer"
                  >
            ...
            <div className="p-8 text-center bg-slate-50 rounded-3xl border border-dashed border-slate-200 text-slate-400 space-y-3">
              <BookOpen className="w-12 h-12 text-slate-300 mx-auto animate-pulse" />
              <p className="text-base font-bold text-slate-500">지식 자산 상세 리더관</p>
