  ...
  return (
    <div className="space-y-12 animate-fade-in text-zinc-800" style={{ fontSize: `${16 * fontRatio}px` }}>
      ...
      <div className="border-b border-zinc-200/60 pb-5 max-w-2xl">
        <span className="text-xs font-bold uppercase text-zinc-800 tracking-wider font-semibold">Storytelling Gallery</span>
        <h1 className="text-lg font-bold text-zinc-900 mt-1">현장 활동 소식 및 미디어 스케치</h1>
          ...
          <button
            ...
            className={`px-4 py-2 rounded-xl text-xs font-bold cursor-pointer transition-all ${
              selectedCategory === cat
                ...
                : "text-slate-550 hover:text-zinc-900 hover:bg-slate-100"
            }`}
          >
            {cat}
          </button>
        ...
        {filteredItems.map((item) => {
          ...
          return (
            <div 
              ...
              className="bg-white rounded-2xl border border-slate-150 overflow-hidden shadow-2xs hover:shadow-lg shadow-zinc-200/50 hover:border-zinc-200 hover:scale-[1.03] hover:-translate-y-1 transition-all duration-300 ease-out cursor-pointer flex flex-col justify-between group"
            >
              ...
              <div className="relative aspect-[16/10] bg-slate-900 overflow-hidden">
                ...
                <span className="absolute bottom-3 left-3 bg-slate-900/80 text-white font-bold text-[10px] px-2.5 py-1 rounded">
                  {item.category}
                </span>
              </div>
              ...
              <div className="p-5 space-y-2.5 flex-1 flex flex-col justify-between">
                <div className="space-y-1">
                  ...
                  <h3 className="font-bold text-zinc-900 text-base leading-snug group-hover:text-zinc-800 transition-colors">
                    {item.title}
                  </h3>
                ...
                <div className="pt-3 border-t border-zinc-200/60 text-right">
                  <span className="text-[10px] font-bold text-zinc-800 inline-flex items-center gap-0.5">
